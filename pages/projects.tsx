    ...
    return (
        ...
        <main className="main">
            ...
            <li><h3>Small/Fun projects</h3>
                    <ul>
                        <li><a href="/games/boom-bust">BOOM / BUST</a><ul><li>A card-and-dice trading game. Push your luck, outwit a rival republic, and cash out before the market crashes.</li></ul></li>
